...
{
    public class ActionLimiter : AbstractAttribute
    {

        public ActionLimiter(Core.WebApi.Response.Character.Attribute data, float coefficient) : base(data, coefficient)
        {
        }
